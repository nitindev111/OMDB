...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchresult = __webpack_require__(187);
	  ...
	  _createClass(Header, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "div",
	        { className: "logo" },
	        _react2.default.createElement("img", { id: "logo", src: "images/omdb-logo.png" }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchdescription = __webpack_require__(188);

	var _searchdescription2 = _interopRequireDefault(_searchdescription);
	...
	var SearchBox = function (_React$Component) {
	    ...
	    function SearchBox(props) {
	        ...
	        _this.getSearchResult = _this.getSearchResult.bind(_this);
	        return _this;
	    }

	    _createClass(SearchBox, [{
	        key: "getSearchResult",
	        value: function getSearchResult(searchKeyword) {
	            var _this2 = this;

	            if (searchKeyword === "" || searchKeyword === undefined) {
	                alert("enter a value");
	            } else {
	                _axios2.default.get("http://www.omdbapi.com/?s=" + searchKeyword).then(function (response) {
	                    _this2.state.searchResult = response.data.Search;
	                    _this2.state.selectedMovie = "";
	                    _this2.state.selectedMovieData = "";
	                    _this2.forceUpdate();
	                });
	            }
	        }
	        ...
	        key: "getMovieData",
	        value: function getMovieData(movie) {
	            var _this3 = this;

	            _axios2.default.get("http://www.omdbapi.com/?i=" + movie.imdbID).then(function (response) {
	                _this3.state.selectedMovieData = response.data;
	                _this3.forceUpdate();
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement("input", { id: "SearchInput", type: "text", onChange: function onChange(event) {
	                        return _this4.state.searchValue = event.target.value;
	                    } }),
	                _react2.default.createElement("input", { id: "SearchButton", type: "button", value: "Search", onClick: function onClick() {
	                        return _this4.getSearchResult(_this4.state.searchValue);
	                    } }),
	                _react2.default.createElement(
	                    "h2",
	                    null,
	                    "THE LARGEST ONLINE MOVIE DATABASE"
	                ),
	                _react2.default.createElement(_searchresult2.default, { result: this.state.searchResult, searchInput: this.state.searchValue, getMovieData: this.getMovieData }),
	                _react2.default.createElement(_searchdescription2.default, { movieSelected: this.state.selectedMovieData })
	            );
	        }
	    }]);
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    searchResult.map(function (movie, index) {
	                        return _react2.default.createElement(
	                            "div",
	                            null,
	                            _react2.default.createElement(
	                                "li",
	                                { key: index },
	                                _react2.default.createElement("img", { alt: movie.Title, src: movie.Poster, onClick: function onClick() {
	                                        return _this2.props.getMovieData(movie);
	                                    } }),
	                                " "
	                            ),
	                            _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchDescription = function (_React$Component) {
	    _inherits(SearchDescription, _React$Component);

	    function SearchDescription(props) {
	        _classCallCheck(this, SearchDescription);

	        return _possibleConstructorReturn(this, (SearchDescription.__proto__ || Object.getPrototypeOf(SearchDescription)).call(this, props));
	    }

	    _createClass(SearchDescription, [{
	        key: "render",
	        value: function render() {
	...
	exports.default = SearchDescription;
